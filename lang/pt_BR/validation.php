...
return [
    ...
    */
    ...
    'min' => [
        ...
        'file' => 'O campo :attribute deve ser de pelo menos :min kilobytes.',
    ...
    'string' => 'O campo :attribute deve ser uma cadeia de caracteres (string).',
    ...
    */
    ...
    'attributes' => [
        ...
        'logo_light' => 'logotipo (tema claro)',
        'logo_dark' => 'logotipo (tema escuro)',
        'login_bg' => 'imagem de fundo do login',
        'footer_name' => 'nome do sistema',
        ...
        'scheduling_enabled' => 'módulo de agendamento',
        'default_department_id' => 'setor padrão',
        'scheduling_custom_prompt' => 'instruções de agendamento',
        'human_agent_id' => 'agente',
        'start_time' => 'início',
        'end_time' => 'término',
