    ...
    <div class="w-full max-w-sm">
        <div class="text-center mb-6">
            @if($branding['logo_url'])
                <img src="{{ $branding['logo_url'] }}" alt="Logotipo" class="w-16 h-16 object-contain mx-auto mb-3 rounded-xl bg-white p-1.5 shadow-lg">
            @endif
            ...
            <h1 class="text-lg font-bold text-gray-800 dark:text-gray-100 {{ $branding['login_bg_url'] ? 'drop-shadow' : '' }}">Painel IA</h1>
            <p class="text-xs text-gray-500 dark:text-gray-400 mt-1 {{ $branding['login_bg_url'] ? 'drop-shadow' : '' }}">Acesso restrito à equipe</p>
        </div>
