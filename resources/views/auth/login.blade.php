...
<body class="bg-gray-50 font-sans text-gray-900 min-h-screen flex items-center justify-center">
    <div class="w-full max-w-sm">
        <div class="text-center mb-6">
            ...
            <h1 class="text-lg font-bold text-gray-800">Painel IA</h1>
            <p class="text-xs text-gray-500 mt-1">Acesso restrito à equipe</p>
        </div>

        <form action="/login" method="POST" class="bg-white p-6 rounded-xl shadow-sm border border-gray-200 space-y-4">
            @csrf
